...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Transporte de carga</div>
            <div class="texto-ventaja">Brinda protección contra riesgos derivados
			de accidentes, averías y actos delictivos, a los que están expuestas las
			mercancías en tránsito transportadas vía aérea, marítima y/o terrestre, 
			dentro y fuera de la República Dominicana. Se cuenta con distintas modalidades
			de contratación. </div>
        </div>
