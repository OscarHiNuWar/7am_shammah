...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Fidelidad 3D</div>
            <div class="texto-ventaja">Es un seguro orientado resarcir 
			cualquier pérdida o daño que uno o varios de tus empleados 
			originen, ya sea por malversación, estafa, abuso de confianza, 
			sustracción de dinero, valores o bienes de tu pertenencia o por 
			los cuales en calidad de patrón seas responsable.</div>
        </div>
