...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Incendio y Líneas aliadas</div>
            <div class="texto-ventaja">Las pólizas de Incendio y Líneas Aliadas ofrecen
			protección a sus propiedades y bienes frente a daños físicos y directos 
			ocasionados de forma accidental.
			
			<ul>
                	<li>Incendio y/o rayo</li>
                    <li>Robo con Escalamiento y/o violencia</li>
                    <li>Motín, huelga y daños maliciosos</li>
                    <li>Terremoto y/o temblor</li>
                    <li>Huracán, ciclón, tornado y manga de viento</li>
                    <li>Inundación y/o ras de mar</li>
					<li>Explosión</li>
					<li>Daños por naves aéreas y vehículos terrestres</li>
					<li>Daños por humo</li>
					<li>Daños por agua accidental</li>
					<li>Colapso y/o derrumbe de estructuras</li>
					<li>Pérdidas indirectas, entre otros</li>
