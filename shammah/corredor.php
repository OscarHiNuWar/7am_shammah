...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Que debe saber de un Corredor de seguros: </div>
            <div class="texto-ventaja"> El Corredor de Seguros trabaja para conseguir las ofertas que 
			mejor se adapten a las necesidades de sus clientes, asistiéndoles, asesorándoles y ayudándoles
			en todos los trámites y gestionando la contratación definitiva de sus contratos de seguros y 
