...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Seguro de Automóvil</div>
            <div class="texto-ventaja">Es un contrato voluntario mediante el cual 
			el propietario de un vehículo traslada a una compañía de seguros los riesgos 
			que pueda sufrir el vehículo, de manera que garantiza que ante la ocurrencia 
			de un choque o un robo, la compañía de seguros compense al asegurado por las 
			pérdidas o daños...</div>
