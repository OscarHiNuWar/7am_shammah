...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Seguro de viaje</div>
            <div class="texto-ventaja">Disfruta de tus viajes en completa tranquilidad
			con nuestros planes de seguros. Donde quiera que vayas queremos acompañarte
			para brindarte la máxima protección.Nuestros Seguros de Viaje se ofrecen en
			modalidades individuales o familiares, adaptados a cualquier destino o duración.<br><br>
			Elije el que más se ajuste a tu necesidad. </div>
