...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
			...
			<div class="grantitulo">Salud Internacional</div>
            <div class="texto-ventaja">Es el seguro médico internacional que te permite disfrutar 
			de más coberturas y ventajas en servicios de salud, con pólizas colectivas individuales 
			y colectivas. Contarás con la seguridad y respaldó ante situaciones imprevistas, como accidentes 
			o enfermedades adquiridas. Para tu comodidad, ofrecemos planes que ten brindarán la protección que 
			tú y tu familia necesitan.</div>
