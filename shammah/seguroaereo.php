...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Seguro de Naves Aéreas y Marítimas</div>
            <div class="texto-ventaja"><b>Las pólizas de naves aéreas y/o
			marítimas otorgan cobertura ante</b> los daños que pueda ocasionar 
			o recibir el casco de la nave, o sus integrantes, como: pasajeros
			y tripulación.</div>
        </div>
