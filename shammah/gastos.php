...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Últimos Gastos</div>
            <div class="texto-ventaja">Es un servicio dirigido a gestionar 
			todos los trámites y pago de servicios que implica llevar a su 
			última morada un ser querido. Puedes incluir a tus familiares 
			desde su nacimiento hasta los 64 años. Una vez cumplidos los 65 
			años, el asegurado permanecerá de por vida con el servicio.
			<br><br>
				
			También puedes optar por la cobertura propia, para que en caso 
			de que faltes, tus parientes no tengan que afrontar todo este proceso 
			funerario y exequial.
</div>
        </div>
