...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Interrupción de Negocios</div>
            <div class="texto-ventaja">El objeto de esta póliza es indemnizar al
			asegurado los perjuicios que un daño material a su propiedad cause a
			los ingresos de su empresa. Este seguro cubre pérdida de beneficios 
			futuros de una empresa como consecuencia de la reducción en el volumen 
			del negocio debido a la paralización total o parcial del mismo, ocasionada 
			por uno de los riesgos cubiertos en la póliza de Incendio y Líneas Aliadas.</div>
        </div>
