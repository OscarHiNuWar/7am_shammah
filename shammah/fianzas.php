...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Fianzas</div>
            <div class="texto-ventaja">Una fianza es una <b>garantía judicial que busca asegurar 
			el cumplimiento de una obligación</b>. La fianza es un importe que se abona en el momento
			de la firma en concepto de depósito para responder de posibles impagos o desperfectos 
			del bien arrendado.</div>
        </div>
