...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Ventajas que te ofrecemos</div>
            <div class="texto-ventaja">Con tan solo autorizarnos como su intermediario ante la institución 
			de seguro podemos asesorarle en los productos que mejor se ajustan a su 
			necesidad,acompañarle en caso de una reclamación, agilizar todos los procesos 
			con las aseguradoras y lo mejor es que no le cuesta más, por el contrario puedes 
			conseguir mejores descuentos…</div>
        </div>
