...
<div class="contenedor-ventajas">
    ...
    <div id="ventaja" class="ventajas">
            <div class="grantitulo">Salud Local</div>
            <div class="texto-ventaja">El seguro sobre las personas comprende todos los riesgos 
			que puedan afectar a la existencia, integridad corporal o salud de un asegurado.</div>
